...
import { AdminUser, SuperAdminDashboard } from "@/types/dashboard";
...
export default function SuperAdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    fetchSuperAdminDashboard(token)
      .then(setDashboard)
      .catch(() => setMessage("Gagal memuat ringkasan super admin."));
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl bg-white p-8 shadow-comfort">
        <h1 className="text-3xl font-semibold text-primary-700">Ringkasan Super Admin</h1>
        {dashboard ? (
      ...
      <section className="rounded-3xl bg-white p-8 shadow-comfort">
        ...
        <p className="mt-2 text-lg text-elderText/80">
          Super admin dapat membuat akun untuk dokter, perawat, keuangan, dan aktor lainnya. Password dapat diisi
